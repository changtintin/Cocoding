        ...
        <form method="post">
            <div class="text-right" style="padding-bottom: 20px;">
                ...
                <div class="btn-group mr-3 " role="group">
                    ...
                    <div class="btn-group mr-3" role="group">
                        <a href="user_posts.php?request=user_add_posts" class="btn btn-primary">
            ...
            <table class="table table-bordered table-hover post_table">
                <thead>
                    <tr>
                        <th scope = "col">ID</th>
                    ...
                    <tbody>
                        <?php
                            ...
                            $sql .="ON P.post_cater_id = C.cat_id )AS T WHERE T.post_author_id = '{$_SESSION['user_id']}'".$order;
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="user_comments.php?pid=<?php echo $id;?>">
                                        <?php echo $comment;?>
                                        </a>
